...
<html>
  ...
  <script language="Javascript" type="text/javascript"> 
   ...
   <div class="Other-page">
	  ...
	  <div class="col-8">
	  <h6>Numero de cuenta Origen</h6>
	  <span>${transfer.numeroCuentaOrigen}</span>
	  </div>
	  
	  <div class="col-4">
	  <h6>Numero de cuenta Destino</h6>
	  <span>${transfer.numeroCuentaDestino}</span>
	  </div>
	  
	  <div class="col-4">
	  <h6>Cantidad</h6>
	  <span>${transfer.cantidad}</span>
	  </div>
	  
	  <div class="col-4">
	  <h6>Fecha</h6>
	  <span>${transfer.fecha}</span>
	  </div>
	  ...
	  <br/>
		...
		<form action="/ElBanco/client/cuentas" method="GET">
