...
public class UsuarioDAO {
	...
	Usuario getUser(String username) throws SQLException{
	...
	Usuario authenticate(String username, String password) throws SQLException{
	...
	void addUser(Usuario newUser) throws SQLException {
